...
public class MyUtil {
	...
	public String paging(int current_page, int total_page, String list_url) {
		...
		if(total_page > numPerBlock && currentPageSetup > 0) {
			sb.append("<li class='disabled'><a href='"+list_url+"page=1'><i class='fa fa-angle-double-left'></i></a></li>");
			sb.append("<li class='disabled'><a href='"+list_url+"page="+n+"'><i class='fa fa-angle-left'></i></a></li>");
		}
		...
		while(page<=total_page && page <=(currentPageSetup+numPerBlock)) {
			if(page==current_page) {
				sb.append("<li class='active'><a href='javascript:void(0)'>"+page+"</a></li>");
			} else {	
		...
		if(total_page-currentPageSetup>numPerBlock) {
			sb.append("<li><a href='"+list_url+"page="+n+"'><i class='fa fa-angle-right'></i></a></li>");
			sb.append("<li><a href='"+list_url+"page="+total_page+"'><i class='fa fa-angle-double-right'></i></a></li>");
		}
		sb.append("</ul>");
