...
public class LoginSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
	...
	@Override
	public void onAuthenticationSuccess(HttpServletRequest reqeust,
		...
		info.setUserIdx(member.getIdx());
		info.setUserId(member.getId());
		info.setUserName(member.getName());
		info.setMemberLevel(member.getIdentCode());
		
		session.setAttribute("member", info);	

		super.onAuthenticationSuccess(reqeust, response, authentication);
	}
